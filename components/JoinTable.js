        ...
        <Flex alignItems="center" justifyContent="center" flexDirection="column">
            ...
            <Flex alignItems="center" justifyContent="center"  flexDirection="column" h={687} w={1000} backgroundColor='#FFF3F3' borderColor="#837A7A" mx="auto" mb={20}>
                ...
                <Box  display="flex" flexDirection="column" alignItems="flex-start" justifyContent="center">              
                    ...
                    <Text fontSize="21" width={700} fontFamily='Open Sans, sans-serif' fontWeight={500} mr={30} lineHeight="0"> Click “Join Now” to become a part of our loyalty program. </Text> 
                </Box>

                <Box display="flex" alignItems="flex-start" justifyContent="center" mt={40}>
                     <Link target="_blank" href="/mailchimp.html"><Button h={60} w={133} fontSize={25} fontWeight={600} color={'white'} mr={8} bg='#A426F1' borderColor='#A426F1' focusBorderColor="transparent">Join Now</Button></Link>
                </Box>
